...
def download_convert_zinc(output_dir: str):
    ...
    zinc_filename = os.path.join(output_dir, "zinc_properties.csv")
    ...
    qm9_filename = os.path.join(output_dir, "QM9IsoFull.csv")
    cep_filename = os.path.join(output_dir, "cep-processed.csv")
    ...
    output_filename = os.path.join(output_dir, "qm9_zinc250_cep.parquet")
