...
def main():
    ...
    if not learning_source_dir:
        ...
        print("Please set LEARNING_SOURCE_DIR before running this script:", file=sys.stderr)
    ...
    if success_count == total_count:
        ...
        print("\n✗ Some files failed to download. Please check the errors above.", file=sys.stderr)
        return 1
