#!/usr/bin/env python3
"""
RNAformer Configuration File Loader
...
_default_config = os.path.join(_this_dir, "configs", "rna.py")

# Parse command-line arguments
parser = argparse.ArgumentParser(description="RNAformer Training Configuration")
...
# not when pdoc or other tools import this module directly as src.rnaformer.configurator.
