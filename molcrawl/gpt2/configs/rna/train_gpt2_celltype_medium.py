# GPT-2 (medium) fine-tuning config for RNA cell type annotation
#
...
#   - pretrain_dir loads weights from rna-medium pretraining
...
tensorboard_dir = get_gpt2_output_path("rna_celltype", "medium")
out_dir = get_gpt2_output_path("rna_celltype", "medium")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("rna", "medium")
