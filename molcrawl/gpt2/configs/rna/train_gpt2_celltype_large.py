# GPT-2 (large) fine-tuning config for RNA cell type annotation
#
...
#   - pretrain_dir loads weights from rna-large pretraining
...
tensorboard_dir = get_gpt2_output_path("rna_celltype", "large")
out_dir = get_gpt2_output_path("rna_celltype", "large")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("rna", "large")
