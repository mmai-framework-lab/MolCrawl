# GPT-2 (xl) fine-tuning config for Mol-Instructions
#
# Continues from the molecule_nat_lang GPT-2 xl pretraining checkpoint
...
#   - pretrain_dir loads weights from molecule_nat_lang-xl pretraining
...
tensorboard = True
tensorboard_dir = get_gpt2_output_path("molecule_nat_lang_mol_instructions", "xl")
out_dir = get_gpt2_output_path("molecule_nat_lang_mol_instructions", "xl")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("molecule_nat_lang", "xl")
