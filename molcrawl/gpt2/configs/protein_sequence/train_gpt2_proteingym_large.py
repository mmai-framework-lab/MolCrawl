# GPT-2 (large) fine-tuning config for ProteinGym DMS sequences
#
# Continues from the protein_sequence GPT-2 large pretraining checkpoint using
...
#   - pretrain_dir loads weights from protein_sequence-large pretraining
...
tensorboard_dir = get_gpt2_output_path("protein_sequence_proteingym", "large")
out_dir = get_gpt2_output_path("protein_sequence_proteingym", "large")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("protein_sequence", "large")
