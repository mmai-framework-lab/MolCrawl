# GPT-2 (large) fine-tuning config for ClinVar genome sequences
#
# Continues from the genome_sequence GPT-2 large pretraining checkpoint using
...
#   - pretrain_dir loads weights from genome_sequence-large pretraining
...
tensorboard_dir = get_gpt2_output_path("genome_sequence_clinvar", "large")
out_dir = get_gpt2_output_path("genome_sequence_clinvar", "large")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("genome_sequence", "large")
