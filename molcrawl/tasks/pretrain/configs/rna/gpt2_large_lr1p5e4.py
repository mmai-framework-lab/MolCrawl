"""rna GPT-2 grid: large at learning rate 1.5e-4.
...
from molcrawl.tasks.pretrain.configs.rna.gpt2_large import *  # noqa: F401,F403
...
out_dir = _os.path.join(_runs_root, "rna-gpt2-large-lr1p5e4")
