...
from molcrawl.core.paths import CELLXGENE_DATASET_DIR, RNA_DATASET_DIR, get_llama_output_path
...
tensorboard_dir = get_llama_output_path("rna", "medium")
out_dir = get_llama_output_path("rna", "medium")
