# rna BERT small -- learning-rate grid, point 1 of 3 (lr 1e-4).
# all-bert-order-2026-09-17 §3.2. The grid is 3 sizes x (1e-4, 3e-4, 1e-3), seed 42 in all nine.
#
# Everything else comes from bert_small.py, imported rather than copied, the way the
...
learning_rate = 1e-4
seed = 42
model_path = get_bert_output_path("rna", "small") + "-lr1e4"
