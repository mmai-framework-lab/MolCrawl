# rna BERT medium -- filling in the grid, learning rate 7.4e-4.
...
#
# medium: 3e-4 to 1e-3, step 1.35x.
#
# Everything else comes from bert_medium.py, imported rather than copied, so these points
...
seed = 42
model_path = get_bert_output_path("rna", "medium") + "-lr7p4e4"
