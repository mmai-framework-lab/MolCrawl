# rna BERT small -- filling in the grid, learning rate 5.5e-4.
...
#
# small: 3e-4 to 1e-3, step 1.35x.
#
# Everything else comes from bert_small.py, imported rather than copied, so these points
...
seed = 42
model_path = get_bert_output_path("rna", "small") + "-lr5p5e4"
