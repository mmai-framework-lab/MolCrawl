...
from molcrawl.core.paths import CELLXGENE_DATASET_DIR, get_roberta_output_path, get_custom_tokenizer_path
...
_custom_tokenizer_path = get_custom_tokenizer_path("rna", "roberta")
...
model_path: str = get_roberta_output_path("rna", model_size)
max_length: int = 1024
