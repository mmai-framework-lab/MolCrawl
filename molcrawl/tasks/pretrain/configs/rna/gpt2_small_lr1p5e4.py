"""rna GPT-2 grid: small at learning rate 1.5e-4.
...
from molcrawl.tasks.pretrain.configs.rna.gpt2_small import *  # noqa: F401,F403
...
out_dir = _os.path.join(_runs_root, "rna-gpt2-small-lr1p5e4")
