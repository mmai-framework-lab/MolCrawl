# protein BERT learning-rate grid — small, point 1/3 (lr 1e-4). Grid arm; reproduces one run.
...
model_path = "/data1/rkp00024/matsubara/protein-bert-grid/bert-small-lr1e4"  # outside LEARNING_SOURCE_DIR (output_guard); distinct per arm
