# protein GPT-2 — large, lr 1.2e-3. protein-order-2026-09-25 §4: probe one grid step
...
# warmup 671 (2%), shape (eff 2,560), block 1,024, dtype bfloat16 all from gpt2_large.py.
# seed 1001 = the 6e-4 comparison arm's seed. Distinct out_dir per arm.
from molcrawl.core.paths import get_gpt2_output_path
from molcrawl.tasks.pretrain.configs.protein_sequence.gpt2_large import *  # noqa: F401,F403

learning_rate = 1.2e-3
min_lr = 1.2e-4            # peak/10
seed = 1001               # match the 6e-4 arm for a same-seed comparison
out_dir = get_gpt2_output_path("protein_sequence", "large") + "-lr1p2e3"
