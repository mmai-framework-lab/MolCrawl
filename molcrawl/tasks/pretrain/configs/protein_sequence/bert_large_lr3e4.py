# protein BERT learning-rate grid — large, point 2/3 (lr 3e-4). Grid arm; reproduces one run.
...
# here because the base bert_large.py leaves adam_beta2 to models/bert/main.py
...
model_path = get_bert_output_path("protein_sequence", "large") + "-lr3e4"
