# protein BERT learning-rate grid — medium, point 3/3 (lr 1e-3). Grid arm; reproduces one run.
...
# here because the base bert_medium.py leaves adam_beta2/warmup_steps to models/bert/main.py
...
model_path = "/data1/rkp00024/matsubara/protein-bert-grid/bert-medium-lr1e3"  # outside LEARNING_SOURCE_DIR (output_guard); distinct per arm
