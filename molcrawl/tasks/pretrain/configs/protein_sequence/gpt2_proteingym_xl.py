# GPT-2 (xl) fine-tuning config for ProteinGym DMS sequences
#
# Continues from the protein_sequence GPT-2 xl pretraining checkpoint using
...
#   - pretrain_dir loads weights from protein_sequence-xl pretraining
...
tensorboard_dir = get_gpt2_output_path("protein_sequence_proteingym", "xl")
out_dir = get_gpt2_output_path("protein_sequence_proteingym", "xl")
# Pretraining checkpoint to load weights from when out_dir has no checkpoint.
pretrain_dir = get_gpt2_output_path("protein_sequence", "xl")
