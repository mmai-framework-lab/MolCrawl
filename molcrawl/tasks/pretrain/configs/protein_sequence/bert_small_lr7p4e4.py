# protein BERT LR grid-fill — small, lr 7.4e-4 (between 3e-4 and 1e-3, log-quartered).
...
# base bert_small.py. seed 42 for grid parity (base seed differs). Distinct out path per arm.
...
seed = 42                   # grid parity
model_path = get_bert_output_path("protein_sequence", "small") + "-lr7p4e4"
