...
# $ python bert/main.py bert/configs/protein_sequence_medium.py
...
from molcrawl.core.paths import UNIPROT_DATASET_DIR, get_roberta_output_path
...
model_path = get_roberta_output_path("protein_sequence", model_size)
max_length = 1024
