...
from molcrawl.core.paths import COMPOUNDS_DATASET_DIR, get_llama_output_path
...
tensorboard_dir = get_llama_output_path("compounds", "medium")
out_dir = get_llama_output_path("compounds", "medium")
