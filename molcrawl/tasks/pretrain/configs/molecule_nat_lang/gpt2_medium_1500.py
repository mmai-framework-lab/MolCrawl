"""mol_nl GPT-2 medium on the 1,500-iteration grid schedule (2026-09-25 order §4).
...
from molcrawl.tasks.pretrain.configs.molecule_nat_lang.gpt2_medium import *  # noqa: F401,F403
