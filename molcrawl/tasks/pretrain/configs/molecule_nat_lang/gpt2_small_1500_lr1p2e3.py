"""mol_nl GPT-2 small at learning rate 1.2e-3, on the 1,500-iteration grid.

Everything but the learning rate comes from gpt2_small_1500.py, imported rather than
