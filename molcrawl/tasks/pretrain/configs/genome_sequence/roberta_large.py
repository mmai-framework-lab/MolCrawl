...
from molcrawl.core.paths import REFSEQ_DATASET_DIR, get_roberta_output_path, get_custom_tokenizer_path, get_refseq_tokenizer_path

model_size = "large"  # Choose between small, medium or large
model_path = get_roberta_output_path("genome_sequence", model_size)
max_length = 1024
...
_custom_tokenizer_path = get_custom_tokenizer_path("genome_sequence", "roberta")
