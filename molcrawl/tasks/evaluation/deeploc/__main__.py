"""CLI for DeepLoc 2.0 subcellular localisation."""
...
from .evaluator import DeepLocEvaluator


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="DeepLoc 2.0 evaluation")
    ...
    parser.add_argument("--deeploc-data", required=True)
