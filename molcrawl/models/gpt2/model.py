...
class GPT(nn.Module):
    ...
    def estimate_mfu(self, fwdbwd_per_iter, dt, flops_promised=312e12):
        """estimate model flops utilization (MFU) as a fraction of the hardware's
        bfloat16 peak. ``flops_promised`` defaults to the A100 (312 TFLOPS); pass
        the peak of the actual accelerator (e.g. GB200) so the ratio is meaningful
        instead of exceeding 100% on faster hardware."""
        ...
        # express our flops throughput as ratio of the accelerator's peak flops
