...
from molcrawl.data.rna.dataset.cellxgene.script.download_by_dataset import download
from molcrawl.data.rna.dataset.cellxgene.script.h5ad_to_loom import h5ad_to_loom
from molcrawl.data.rna.dataset.cellxgene.script.scgpt_tokenization import get_census_gene_vocab
from molcrawl.data.rna.dataset.tokenization import tokenize
...
def process_celltype_finetune(force: bool = False) -> bool:
    ...
    """
    from molcrawl.data.rna.dataset.celltype.prepare_celltype import (
        download_celltype,
        prepare_celltype,
    )
...
if __name__ == "__main__":
    ...
    if not args.force and download_marker.exists():
        ...
        from molcrawl.data.rna.dataset.cellxgene.script.download import divide_workload
