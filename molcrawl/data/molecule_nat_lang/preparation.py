...
from molcrawl.data.molecule_nat_lang.utils.general import compute_resource_aware_params, read_dataset, save_dataset
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "molcrawl.data.molecule_nat_lang.dataset.prepare_mol_instructions."
        ),
    )
    parser.add_argument(
        "--download-only",
    ...
    if "mol_instructions" in args.datasets:
        from molcrawl.data.molecule_nat_lang.dataset.download import download_mol_instructions
        from molcrawl.data.molecule_nat_lang.dataset.prepare_mol_instructions import (
