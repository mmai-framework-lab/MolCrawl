...
from molcrawl.data.compounds.dataset.dataset_config import DatasetInfo, CompoundDatasetType
from molcrawl.data.compounds.utils.tokenizer import CompoundsTokenizer, ScaffoldsTokenizer
...
class DatasetTokenizer:
    ...
    def _report_invalid_smiles_stats(self):
        ...
        from molcrawl.data.compounds.utils.preprocessing import get_invalid_smiles_stats
...
def compute_tokenization_statistics(
    ...
    """
    from molcrawl.data.compounds.dataset.dataset_config import get_dataset_info, DATASET_DEFINITIONS
