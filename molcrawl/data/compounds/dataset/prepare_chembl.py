...
Usage
─────
    python -m molcrawl.data.compounds.dataset.prepare_chembl       # uses CHEMBL_* constants
    python -m molcrawl.data.compounds.dataset.prepare_chembl --force
"""
...
def prepare_chembl(
    ...
    from molcrawl.data.compounds.utils.tokenizer import CompoundsTokenizer as _Tok
