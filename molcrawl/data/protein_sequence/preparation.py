...
from molcrawl.data.protein_sequence.dataset.tokenizer import EsmSequenceTokenizer, tokenize_to_parquet
from molcrawl.data.protein_sequence.dataset.uniprot.fasta_to_raw import fasta_to_raw_protein
from molcrawl.data.protein_sequence.dataset.uniprot.uniprot_download import process_dataset
from molcrawl.data.protein_sequence.utils.configs import ProteinSequenceConfig
...
def process_proteingym(force: bool = False) -> bool:
    ...
    """
    from molcrawl.data.protein_sequence.dataset.download_proteingym import download_proteingym
    from molcrawl.data.protein_sequence.dataset.prepare_proteingym import prepare_proteingym
