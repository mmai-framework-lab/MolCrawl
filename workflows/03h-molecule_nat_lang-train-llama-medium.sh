...
LOG_FILE="${LEARNING_SOURCE_DIR}/molecule_nat_lang/logs/molecule_nat_lang-train-llama-medium-$(date +%Y-%m-%d_%H-%M-%S).log"
run_training_background "$LOG_FILE" \
    molcrawl/models/llama/train.py \
    ./molcrawl/tasks/pretrain/configs/molecule_nat_lang/llama_medium.py
