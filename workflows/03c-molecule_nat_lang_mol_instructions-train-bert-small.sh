...
run_training_background "${LOG_DIR}/molecule_nat_lang_mol_instructions-train-bert-small-$(date +%Y-%m-%d_%H-%M-%S).log" \
    molcrawl/models/bert/main.py \
    molcrawl/tasks/pretrain/configs/molecule_nat_lang/bert_mol_instructions_small.py
