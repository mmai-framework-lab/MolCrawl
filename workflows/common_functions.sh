...
#
# Examples:
#   run_training molcrawl/models/gpt2/train.py molcrawl/tasks/pretrain/configs/compounds/gpt2_small.py
#   run_training molcrawl/models/bert/main.py molcrawl/tasks/pretrain/configs/compounds/bert_small.py
run_training() {
    local script="$1"
    shift
    local args="$@"
