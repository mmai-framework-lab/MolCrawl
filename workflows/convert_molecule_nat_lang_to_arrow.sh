...
#
# Usage:
#   bash workflows/convert_molecule_nat_lang_to_arrow.sh
#
...
PARQUET_FILE="${LEARNING_SOURCE_DIR}/molecule_nat_lang/molecule_related_natural_language_tokenized.parquet"
OUTPUT_DIR="${LEARNING_SOURCE_DIR}/molecule_nat_lang/arrow_splits"
