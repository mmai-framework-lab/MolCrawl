...
run_training_background "${LOG_DIR}/compounds_guacamol-train-bert-medium-$(date +%Y-%m-%d_%H-%M-%S).log" \
    molcrawl/models/bert/main.py \
    molcrawl/tasks/pretrain/configs/compounds/bert_guacamol_medium.py
