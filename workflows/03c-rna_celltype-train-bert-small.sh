#!/bin/bash
# Fine-tune the rna BERT (small) model on the Geneformer cell type
# annotation dataset.
#
# Prerequisites:
#   - rna BERT pretraining checkpoint must exist in
#       $LEARNING_SOURCE_DIR/rna/bert-output/rna-small/
...
#   bash workflows/03c-rna_celltype-train-bert-small.sh
