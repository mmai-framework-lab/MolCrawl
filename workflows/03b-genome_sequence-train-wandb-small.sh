...
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} nohup bash -c "python src/gpt2/train.py ./gpt2/configs/genome_sequence/train_gpt2_config.py --use_wandb=True --wandb_project='genome-sequence' --wandb_entity='kaz-matsu-de-riken'" > \
