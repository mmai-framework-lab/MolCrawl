...
test_data = torch.load(os.path.join(data_dir, 'train.pt'))  # For now, we use the training data for validation as we want to overfit to confirm the model is working with the data
...
if not ('meta_vocab_size' in vars() and 'meta_vocab_size' in globals()):
    try:
        ...
        raise ImportError("Please initialize the variable meta_vocab_size in the *_config.py file with the size of your vocabulary.")
