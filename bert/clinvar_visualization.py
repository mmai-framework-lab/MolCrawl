...
class BERTClinVarVisualizationGenerator(BaseVisualizationGenerator):
    ...
    def _validate_csv_results(self):
        """CSV結果データの検証"""
        required_columns = ['pathogenic', 'mlm_score', 'cosine_similarity', 'confidence']
    ...
    def plot_mlm_score_distribution(self):
        ...
        # 統計情報をテキストで表示
        plt.text(0.02, 0.98, f'Pathogenic Mean: {path_mean:.3f}\nBenign Mean: {benign_mean:.3f}', 
    ...
    def create_summary_dashboard(self):
        ...
        if self.results_df is not None:
            ...
            sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
                       ...
                       yticklabels=['Act Benign', 'Act Pathogenic'], ax=ax1)
            ...
            ax5.scatter(pathogenic_data['mlm_score'], pathogenic_data['cosine_similarity'], 
                       alpha=0.6, c='red', label='Pathogenic', s=10)
            ax5.scatter(benign_data['mlm_score'], benign_data['cosine_similarity'], 
                       alpha=0.6, c='blue', label='Benign', s=10)
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='./bert_clinvar_visualization_results',
