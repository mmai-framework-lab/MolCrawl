...
dataset: "src/molecule_nat_lang/assets/raw_data/osunlp/SMolInstruct"
...
```python
from molecule_nat_lang.utils.general import read_dataset
...
```bash
python src/molecule_nat_lang/dataset/prepare_gpt2.py assets/configs/molecules_nl.yaml
```
