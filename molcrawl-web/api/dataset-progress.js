  ...
  compounds: {
    ...
    steps: [
      ...
      },
      {
        ...
        checkFiles: ['data/opv_molecular_properties.csv'],
        outputDirs: ['data/opv'],
        description: '有機太陽電池材料データ',
      },
      {
        id: 'download_additional',
        name: 'Additional Datasets Download',
        marker: 'data/additional_download.marker',
        checkFiles: ['data/additional_datasets'],
        outputDirs: ['data/additional_datasets'],
        description: 'リポジトリからの追加データセット',
      },
      {
        id: 'combine',
