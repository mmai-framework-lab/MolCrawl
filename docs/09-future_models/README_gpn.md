...
This folder contains the code for training and inferencing with the Genome sequence with mixed species GPN-MSA for both BERT and GPT-2 models.
...
Download the MSA dataset from <https://Hugging Face.co/datasets/songlab/multiz100way/resolve/main/89.zarr.zip> and uncompress it. The path to the uncompressed folder 89.zarr should be provided in the argument `--msa_path` in the next section.
