...
-  [dnabert2/main.py](../../molcrawl/dnabert2/main.py) - メイン学習スクリプト (433行)
-  [dnabert2/configurator.py](../../molcrawl/dnabert2/configurator.py) - 設定ローダー
-  [dnabert2/configs/genome_sequence.py](../../molcrawl/dnabert2/configs/genome_sequence.py) - genome_sequence設定
