...
4. **Model integration** - BERT/GPT-2モデルとの統合
...
**TestCompoundsGPT-2Integration** - GPT-2 モデル統合
...
**目的**: Phase 1（機能検証）のBERT/GPT-2チェック
...
- [Transformers ドキュメント](https://Hugging Face.co/docs/transformers/)
