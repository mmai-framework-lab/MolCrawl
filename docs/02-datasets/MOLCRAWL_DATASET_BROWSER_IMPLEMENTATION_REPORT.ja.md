...
`learning_source` ディレクトリをブラウザから確認できるデータセットブラウザの構築が完了しました。
...
```json
{
  ...
  "data": {
    ...
    "size": 0,
    "count": 3,
    "path": "<PROJECT_ROOT>/learning_source",
    "children": [
      {
        "name": "cellxgene",
        "type": "directory",
...
`learning_source` の可視化基盤が実装され、以下を達成しました。
...
利用開始URL: <http://localhost:3001/test.html>
