...
`bert/molecule_nat_lang_bert_config.py`を編集：
...
# または環境変数で指定
LEARNING_SOURCE_DIR="learning_source" python gpt2/train.py --config=gpt2/molecule_nat_lang_gpt2_config.py
```

### 3. 設定のカスタマイズ (GPT-2)

`gpt2/molecule_nat_lang_gpt2_config.py`を編集：
...
```bash
LEARNING_SOURCE_DIR="learning_source" python src/preparation/test_molecule_nat_lang_compatibility.py
```
...
詳細は`docs/molecule_nat_lang_dataset_comparison_report.md`を参照してください。
...
2. **互換性テスト**: `python src/preparation/test_molecule_nat_lang_compatibility.py`
3. **BERT学習開始**: `python bert/main.py bert/molecule_nat_lang_bert_config.py`
4. **GPT-2学習開始**: `python gpt2/train.py --config=gpt2/molecule_nat_lang_gpt2_config.py`

---

## 参考リンク

- [データセット比較レポート](../docs/molecule_nat_lang_dataset_comparison_report.md)
- [SMolInstructデータセット](https://huggingface.co/datasets/osunlp/SMolInstruct)
- [BERT設定例](bert/molecule_nat_lang_bert_config.py)
- [GPT-2設定例](gpt2/molecule_nat_lang_gpt2_config.py)
